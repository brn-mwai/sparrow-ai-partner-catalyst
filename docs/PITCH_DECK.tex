...
% -------------------- Title Info --------------------
\title{\textbf{SPARROW AI}}
\subtitle{AI-Powered Sales Training Platform}
\author{Never Wing a Call Again}
\date{December 2024}
\institute{sparrow-ai.vercel.app}
...
\textcolor{sparrowred}{\faTimesCircle} \textbf{Can't learn from books}\\[0.2cm]
\textcolor{sparrowred}{\faTimesCircle} \textbf{Can't learn from videos}\\[0.2cm]
\textcolor{sparrowred}{\faTimesCircle} \textbf{Can't practice on managers}\\
{\small\textcolor{sparrowgray}{(they're busy \& biased)}}\\[0.2cm]
\textcolor{sparrowred}{\faTimesCircle} \textbf{Can't practice on real prospects}\\
{\small\textcolor{sparrowgray}{(every miss = lost deal)}}
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Where Reps Actually ``Learn'':}\\[0.3cm]
\textcolor{sparrowred}{\faExclamationTriangle} On real prospects = Lost revenue\\[0.2cm]
\textcolor{sparrowred}{\faExclamationTriangle} On first 50 calls = Burned leads\\[0.2cm]
\textcolor{sparrowred}{\faExclamationTriangle} In their head = No feedback\\[0.5cm]
...
\begin{center}
\begin{tikzpicture}
\node[draw=sparrowdark, line width=1pt, rounded corners=8pt, fill=sparrowlight, minimum width=13cm, minimum height=3cm, align=left] {
\hspace{0.5cm}\begin{minipage}{12cm}
\textbf{For a 50-Person Sales Team:}\\[0.3cm]
\begin{tabular}{ll}
\textbullet\ 33 reps miss quota annually (67\%) & \textbullet\ Replacement cost: \$1.27M/year\\
\textbullet\ 13 reps turn over (26\%) & \textbullet\ Lost productivity: \$520K\\
\end{tabular}\\[0.3cm]
...
\textcolor{sparrowblue}{\faPhone}\\
\textbf{Cold Call}\\
{\small Book a meeting}\\[0.4cm]
\textcolor{sparrowgreen}{\faSearch}\\
\textbf{Discovery}\\
{\small Uncover pain}\\[0.4cm]
\textcolor{sparroworange}{\faBolt}\\
...
\hrule
\vspace{0.2cm}
{\scriptsize\faUser\ \textbf{Sarah Chen}}\\
...
{\scriptsize\faCrosshairs\ \textbf{Goal:}}\\
{\scriptsize Book 30-min demo}\\[0.2cm]
{\scriptsize\faExclamationTriangle\ \textbf{Objections:}}\\
{\scriptsize ``Not looking now''}\\
{\scriptsize ``How are you different?''}
\end{minipage}
};
\end{tikzpicture}
\end{column}
...
\hrule
\vspace{0.3cm}
{\Large\faCircle\ \textbf{02:34}}\\[0.3cm]
...
{\scriptsize that decision?''}\\[0.2cm]
\hrule
\vspace{0.2cm}
{\scriptsize\faMicrophoneSlash\ \faPhoneSlash\ \faPause}
\end{minipage}
};
\end{tikzpicture}
\end{column}
...
\hrule
\vspace{0.2cm}
{\scriptsize\textcolor{sparrowgreen}{\faCheckCircle}\ Meeting Booked}\\
...
\hrule
\vspace{0.2cm}
{\scriptsize\textcolor{sparroworange}{\faLightbulb}\ \textbf{1:12} Missed opp:}\\
...
\begin{tabular}{p{2.8cm}|p{3cm}}
\textbf{\small Traditional} & \textbf{\small Sparrow}\\
\hline
{\scriptsize Read a book} & {\scriptsize Practice out loud}\\
{\scriptsize Watch a video} & {\scriptsize Real-time pushback}\\
{\scriptsize Roleplay w/ manager} & {\scriptsize AI like real buyers}\\
{\scriptsize ``That was good''} & {\scriptsize Timestamped feedback}\\
{\scriptsize Real prospects} & {\scriptsize Safe to fail}\\
{\scriptsize Work hours only} & {\scriptsize Available 24/7}\\
\end{tabular}

\vspace{0.5cm}

\textbf{Competitive Advantages:}\\[0.2cm]
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Voice-first (not chatbots)}\\
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Dynamic personas every time}\\
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Objective, consistent scoring}\\
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Adaptive difficulty}
...
\begin{tikzpicture}
\node[draw=sparrowblue, line width=2pt, rounded corners=5pt, fill=sparrowblue!10, minimum width=7cm, minimum height=1.8cm, align=left] {
...
\begin{tikzpicture}
\node[draw=sparrowgreen, line width=2pt, rounded corners=5pt, fill=sparrowgreen!10, minimum width=7cm, minimum height=1.8cm, align=left] {
\hspace{0.3cm}\begin{minipage}{6.5cm}
...
\begin{tikzpicture}
\node[draw=sparroworange, line width=2pt, rounded corners=5pt, fill=sparroworange!10, minimum width=7cm, minimum height=1.8cm, align=left] {
\hspace{0.3cm}\begin{minipage}{6.5cm}
...
\textbf{Why Now:}\\[0.2cm]
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Voice AI ready (2024)}\\
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ 91\% miss quota}\\
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Remote sales growth}\\
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ \$2K/rep budget exists}
...
\begin{center}
{\small\textcolor{sparrowgray}{Sources: BLS, US Census, HubSpot Research, QuotaPath, Training Magazine}}
\end{center}
...
\begin{tabular}{ccc}
\begin{tikzpicture}
\node[draw=sparrowgray, line width=1pt, rounded corners=5pt, fill=white, minimum width=2.8cm, minimum height=3cm, align=center] {
...
&
\begin{tikzpicture}
\node[draw=sparrowblue, line width=2pt, rounded corners=5pt, fill=sparrowblue!10, minimum width=2.8cm, minimum height=3cm, align=center] {
\begin{minipage}{2.5cm}
\centering
\textbf{Pro}\\[0.2cm]
...
\begin{tikzpicture}
\node[draw=sparrowdark, line width=1pt, rounded corners=5pt, fill=sparrowlight, minimum width=5cm, minimum height=3.5cm, align=left] {
\hspace{0.3cm}\begin{minipage}{4.5cm}
{\small Cost per call:} \hfill {\small \$0.50-1.00}\\[0.1cm]
{\small Calls per Pro user:} \hfill {\small 30-50/mo}\\[0.1cm]
{\small Cost per user:} \hfill {\small \textasciitilde\$25/mo}\\[0.1cm]
{\small Revenue per user:} \hfill {\small \$79/mo}\\[0.2cm]
\hrule
\vspace{0.2cm}
...
\textcolor{sparrowgreen}{\faCheckCircle}\ Working voice AI (ElevenLabs)\\[0.15cm]
\textcolor{sparrowgreen}{\faCheckCircle}\ Dynamic personas (Gemini)\\[0.15cm]
\textcolor{sparrowgreen}{\faCheckCircle}\ Real-time scoring (Groq)\\[0.15cm]
\textcolor{sparrowgreen}{\faCheckCircle}\ 3 practice modes\\[0.15cm]
\textcolor{sparrowgreen}{\faCheckCircle}\ Post-call debrief\\[0.15cm]
\textcolor{sparrowgreen}{\faCheckCircle}\ User auth \& dashboard\\[0.15cm]
\textcolor{sparrowgreen}{\faCheckCircle}\ Deployed on Vercel\\[0.3cm]
...
\textbf{Live at: sparrow-ai.vercel.app}
};
\end{tikzpicture}
...
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ \$5.7B TAM, 13-15\% CAGR}\\[0.15cm]
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ 91\% miss quota --- desperate for solutions}\\[0.15cm]
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Voice AI finally ready}\\[0.15cm]
{\small\textcolor{sparrowgreen}{\faCheckCircle}\ Path to \$45M ARR (Year 5)}
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Why Sparrow Wins:}\\[0.3cm]
{\small\textcolor{sparrowblue}{\faCheckCircle}\ Voice-first (not chatbots)}\\[0.15cm]
{\small\textcolor{sparrowblue}{\faCheckCircle}\ Realistic AI prospects}\\[0.15cm]
{\small\textcolor{sparrowblue}{\faCheckCircle}\ Objective scoring}\\[0.15cm]
{\small\textcolor{sparrowblue}{\faCheckCircle}\ Available 24/7}
\end{column}
\end{columns}
...
{\small\textcolor{sparrowgray}{Contact: team@sparrow-ai.com}}
